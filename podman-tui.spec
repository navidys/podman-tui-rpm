...
Provides: bundled(golang(github.com/containerd/containerd)) = v1.6.2
Provides: bundled(golang(github.com/containerd/stargz_snapshotter/estargz)) = v0.11.3
Provides: bundled(golang(github.com/containers/buildah)) = v1.25.1
Provides: bundled(golang(github.com/containers/common)) = v0.47.5
Provides: bundled(golang(github.com/containers/image/v5)) = v5.20.0
...
Provides: bundled(golang(github.com/containers/podman/v4)) = v4.0.3
Provides: bundled(golang(github.com/containers/psgo)) = v1.7.2
Provides: bundled(golang(github.com/containers/storage)) = v1.39.0
...
Provides: bundled(golang(github.com/klauspost/compress)) = v1.15.1
...
Provides: bundled(golang(github.com/moby/sys/mountinfo)) = v0.6.0
...
Provides: bundled(golang(github.com/sylabs/sif/v2)) = v2.3.2
